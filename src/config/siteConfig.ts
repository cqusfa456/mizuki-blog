...
export const siteConfig: SiteConfig = {
	title: "CQU·SFA",
	subtitle: "重庆大学多时空科幻协会",
	siteURL: "https://cqusfa.dpdns.org/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-07-11", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				"欢迎来到重庆大学多时空科幻协会！",
				"Welcome to the Chongqing University Multi-Dimensional Science Fiction Association!",
			],
			typewriter: {
